    ...
    <>
      ...
      <div className="bg-secondary text-white py-16 px-8 md:flex md:items-center md:justify-between">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <p className="text-lg">
            Chez NetEra DigiNest, nous sommes spécialisés dans la création de
            sites web modernes et de stratégies marketing digitales innovantes. Nos
            solutions sont conçues pour faire briller votre marque.
          </p>
        </div>
